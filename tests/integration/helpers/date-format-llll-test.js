...
module('helper:date-format-llll', function(hooks) {
  setupRenderingTest(hooks);

  test('when date is missing', async function(assert) {
    await render(hbs`{{date-format-llll}}`);
  ...
  test('when date is undefined', async function(assert) {
    ...
    await render(hbs`{{date-format-llll date}}`);
  ...
  test('when custom formatted', async function(assert) {
    ...
    await render(hbs`{{date-format-llll date timeZoneName="short"}}`);

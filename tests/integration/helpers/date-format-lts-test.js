...
module('helper:date-format-lts', function(hooks) {
  setupRenderingTest(hooks);

  test('when date is missing', async function(assert) {
    await render(hbs`{{date-format-lts}}`);
  ...
  test('when date is undefined', async function(assert) {
    ...
    await render(hbs`{{date-format-lts date}}`);
  ...
  test('when custom formatted', async function(assert) {
    ...
    await render(hbs`{{date-format-lts date timeZoneName="short"}}`);
